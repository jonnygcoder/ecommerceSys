                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">+ x -</a></li>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2">Total de Ventas</p>
                                <h4 class="mb-2">56</h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2">Nuevas Ordenes</p>
                                <h4 class="mb-2">3</h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2">Nuevos Usuarios</p>
                                <h4 class="mb-2">5</h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2">Visitadores</p>
                                <h4 class="mb-2">10</h4>
